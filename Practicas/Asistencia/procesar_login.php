...
function clean_input($data) {
    $data = trim($data); // limpia los espacios adelante y atras
    $data = stripslashes($data); // saca las barras
    $data = htmlspecialchars($data); // limpia
    return $data; // devuelve el data
}
